...
const SpecialtiesSection = () => {
  ...
  return (
    <section id="especialidad" className="section-padding bg-white" aria-label="Especialidad">
      <div className="content-width" ref={ref}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 border-t border-l border-foreground/10">
          {specialties.map((s, i) => (
            <article
              key={s.title}
              className="p-8 sm:p-10 border-b border-r border-foreground/10"
