        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <blockquote key={i} className="flex flex-col relative">
              ...
              <p className="text-charcoal text-[15px] leading-relaxed mb-4 mt-8 italic font-serif">
                "{review.text}"
              </p>
              <div className="flex gap-0.5 mb-3">
                {Array.from({ length: review.rating }).map((_, j) => (
                  <svg key={j} width="14" height="14" viewBox="0 0 24 24" fill="#FBBF24" className="drop-shadow-sm">
